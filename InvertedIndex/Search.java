...
public class Search extends Configured implements Tool {
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (res == 0) {
            String[] args1 = new String[]{args[1] + "_temp", args[1]};
            res = ToolRunner.run(new Rank(), args1);
        }
        System.exit(res);
    }
    ...
    public int run(String[] args) throws Exception {
        ...
        FileOutputFormat.setOutputPath(j1, new Path(args[1] + "_temp"));
    ...
    /**
     * Input : fileName tfIdf/ query string from configuration 
     * Output : fileName tfIdf/ if query matches document 
     */
     ...
     * Output: filename score(sum of tfidfs)
     */
